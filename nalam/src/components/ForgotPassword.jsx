...
export default function ForgotPassword() {
  ...
  async function handleSendOTP(e) {
    ...
    setLoading(true)
    try {
      const res = await fetch('http://localhost:4000/auth/forgot-password/send-otp', {
        method: 'POST',
  ...
  async function handleVerifyOTP(e) {
    ...
    setLoading(true)
    try {
      const res = await fetch('http://localhost:4000/auth/forgot-password/verify-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  async function handleResetPassword(e) {
    ...
    setLoading(true)
    try {
      const res = await fetch('http://localhost:4000/auth/forgot-password/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
